...
hp = {}
hp["epochs"] = 500000  # Fewer epochs for testing initially
...
hp["shapefile"] = None  # No shapefile needed for this dataset
...
print("Hyperparameters:", experiment.params)
experiment.compile()
